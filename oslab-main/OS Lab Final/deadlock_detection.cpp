...
//.cpp code run in linux
#include <bits/stdc++.h>
using namespace std;

int n, m;
void deadlock_check(vector<vector<int>> &allocation, vector<vector<int>> &request, vector<int> &availability, vector<bool> &finish)
{
    vector<int> process;
    while (true)
    {
    ...
    else
    {
        cout << "Deadlock detected"
             << "\n";
        cout << "Following processes are in deadlock: ";
